...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'G-Tracer';
$config['webmaster_email'] = 'nuts@jumpingnuts.com';
...
$config['recaptcha_public_key'] = '6Ldxd_wSAAAAAEiLOR_kMwSVAk0OA-IaaG2sRajM';
$config['recaptcha_private_key'] = '6Ldxd_wSAAAAAICtEsPPkfKdCqMgXKL4HW19_3hi';
