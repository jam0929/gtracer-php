  ...
  <div class="col-md-12">
		<div class="col-separator col-separator-first bg-none">
			<div class="col-table">
				...
				<div class="innerTB">
					<h3 class="margin-none pull-left">상품 및 카테고리 분석-이커머스</h3>
...
<div class="box-generic padding-none overflow-hidden">
    ...
    <div class="innerAll inner-2x bg-gray">
        ...
        <table 
            ...
            data-ga-dimensions="ga:productCategory"
            data-ga-sort="-ga:itemQuantity"
            data-chart-type="table"
            data-subchart="true"
            data-subchart-metrics="ga:itemQuantity,ga:itemRevenue"
            data-subchart-dimensions="ga:productCategory,ga:sourceMedium"
            data-subchart-sort="-ga:itemQuantity"
            data-subchart-filters="ga:productCategory=="
            data-subchart-filter-index="1"
            data-subchart-column-header="카테고리명,채널,판매수량,수익"
            data-subchart-column-type="str,str,num,won"
        >
            <thead>
            <tr>
