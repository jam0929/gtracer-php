  ...
  <div class="col-md-12">
		<div class="col-separator col-separator-first bg-none">
			<div class="col-table">
				...
				<div class="innerTB">
					<h3 class="margin-none pull-left">목표분석-<?php echo $this->data['goal']->goal_name; ?></h3>
					<ul class=" list-inline pull-right">
                        ...
                        <li>
                            <a 
                                ...
                                data-filename="목표분석-<?php echo $this->data['goal']->goal_name; ?>"
                                href="#" 
...
<div class="box-generic padding-none overflow-hidden">
    <div class="heading-buttons innerR half border-bottom bg-primary">
        <h4 class="innerAll margin-none pull-left text-white"><i class="fa fa-fw fa-money"></i><?php echo $this->data['goal']->goal_name; ?></h4>
        <div class="clearfix"></div>
    </div>
    <div class="innerAll inner-2x bg-gray">
        ...
        <table 
            ...
            data-ga-metrics="ga:goal<?php echo $this->data['goal']->goal_number; ?>Starts,ga:goal<?php echo $this->data['goal']->goal_number; ?>Completions,ga:goal<?php echo $this->data['goal']->goal_number; ?>ConversionRate,ga:goal<?php echo $this->data['goal']->goal_number; ?>Abandons,ga:goal<?php echo $this->data['goal']->goal_number; ?>AbandonRate"
            data-ga-dimensions="ga:sourceMedium"
            data-ga-sort="-ga:goal<?php echo $this->data['goal']->goal_number; ?>Completions"
        ...
        >
            ...
            <tr>
                ...
                <th>채널</th>
                <th class="center" data-type="numeric" ><?php echo $this->data['goal']->goal_name; ?> 시작수</th>
                <th class="center" data-type="numeric" ><?php echo $this->data['goal']->goal_name; ?> 완료수</th>
                <th class="center" data-type="numeric" data-view-mode="percent"><?php echo $this->data['goal']->goal_name; ?> 전환율</th>
                <th class="center" data-type="numeric" ><?php echo $this->data['goal']->goal_name; ?> 중단수</th>
                <th class="center" data-type="numeric" data-view-mode="percent"><?php echo $this->data['goal']->goal_name; ?> 중단율</th>
            </tr>
            </thead>
            <tbody>
            </tbody>
