  ...
  <div class="col-md-12">
		<div class="col-separator col-separator-first bg-none">
			<div class="col-table">
				...
				<div class="innerTB">
					<h3 class="margin-none pull-left">유입분석-이커머스</h3>
...
<div class="box-generic padding-none overflow-hidden">
    ...
    <div class="innerAll inner-2x bg-gray">
        ...
        <table 
            ...
            data-ga-metrics="ga:transactions,ga:transactionsPerSession,ga:transactionRevenue"
            data-ga-dimensions="ga:sourceMedium"
            data-ga-sort="-ga:transactions"
        ...
        >
            ...
            <tr>
                ...
                <th class="center" data-type="numeric" data-view-mode="percent">전환율</th>
