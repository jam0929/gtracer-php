  ...
  <div class="col-md-12">
		<div class="col-separator col-separator-first bg-none">
			<div class="col-table">
				...
				<div class="innerTB">
					<h3 class="margin-none pull-left">유입분석-세션</h3>
...
<div class="box-generic padding-none overflow-hidden">
    <div class="heading-buttons innerR half border-bottom bg-primary">
        <h4 class="innerAll margin-none pull-left text-white"><i class="fa fa-fw fa-money"></i>세션</h4>
        <div class="clearfix"></div>
    </div>
    <div class="innerAll inner-2x bg-gray">
        ...
        <table 
            ...
            data-ga-metrics="ga:sessions,ga:bounces,ga:bounceRate,ga:avgSessionDuration"
            data-ga-dimensions="ga:sourceMedium"
            data-ga-sort="-ga:sessions"
        ...
        >
            ...
            <tr>
                ...
                <th>채널</th>
                <th class="center" data-type="numeric">접속수</th>
                <th class="center" data-type="numeric">이탈수</th>
                <th class="center" data-type="numeric" data-view-mode="percent">이탈율</th>
                <th class="center" data-type="numeric" data-view-mode="second">머문시간(평균)</th>
            </tr>
            </thead>
            <tbody>
            </tbody>
