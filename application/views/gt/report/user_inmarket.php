  ...
  <div class="col-md-12">
		<div class="col-separator col-separator-first bg-none">
			<div class="col-table">
				...
				<div class="innerTB">
					<h3 class="margin-none pull-left">사용자 성향 분석-인마켓</h3>
...
<div class="box-generic padding-none overflow-hidden">
    <div class="heading-buttons innerR half border-bottom bg-primary">
        <h4 class="innerAll margin-none pull-left text-white"><i class="fa fa-fw fa-money"></i>인마켓</h4>
        <div class="clearfix"></div>
    </div>
    <div class="innerAll inner-2x bg-gray">
        ...
        <table 
            ...
            data-ga-dimensions="ga:interestInMarketCategory"
